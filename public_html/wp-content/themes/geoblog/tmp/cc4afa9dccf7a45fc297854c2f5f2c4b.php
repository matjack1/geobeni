...
?><!--Charset  --><meta content="text/html;charset=UTF-8" http-equiv="Content-type" /><!--Stylesheets  --><!--screen.css is loaded by default with wp_head() function. See config/initializers/default_hooks.php for details  --><!--HTML5 Shiv  -->
